  ...
  return (
    ...
    >
      <SwiperContext.Provider value={swiperRef}>
        ...
        <div class=" tajawal_black swiper-wrapper">
        ...
        <Show when={needsNavigation(params().params)}>
          <div ref={prevElRef} class=" tajawal_black swiper-button-prev" />
          <div ref={nextElRef} class=" tajawal_black swiper-button-next" />
        </Show>
        <Show when={needsScrollbar(params().params)}>
          <div ref={scrollbarElRef} class=" tajawal_black swiper-scrollbar" />
        </Show>
        <Show when={needsPagination(params().params)}>
          <div ref={paginationElRef} class=" tajawal_black swiper-pagination" />
        </Show>

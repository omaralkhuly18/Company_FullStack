...
>
  ...
  <svelte:element this={wrapperTag} class=" tajawal_black swiper-wrapper">
    <slot name="wrapper-start" />
    <slot {virtualData} />
    <slot name="wrapper-end" />
  </svelte:element>
  {#if needsNavigation(swiperParams)}
    <div bind:this={prevEl} class=" tajawal_black swiper-button-prev" />
    <div bind:this={nextEl} class=" tajawal_black swiper-button-next" />
  {/if}
  {#if needsScrollbar(swiperParams)}
    <div bind:this={scrollbarEl} class=" tajawal_black swiper-scrollbar" />
  {/if}
  {#if needsPagination(swiperParams)}
    <div bind:this={paginationEl} class=" tajawal_black swiper-pagination" />
  {/if}

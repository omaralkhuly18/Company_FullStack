const a = document.getElementById("liveAlertPlaceholder"),
	...
	r = (t, n) => {
		...
		e.innerHTML = [`<div class=" tajawal_black alert mb-2 alert-${n} alert-dismissible" role="alert">`, `   <div>${t}</div>`, '   <button type="button" class=" tajawal_black btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="bi bi-x"></i></button>', "</div>"].join(''), a.append(e)
	};

...
const nav_menu = document.querySelector(".main-menu")
const nav2_outer = document.querySelector(".responcive2")
hamburger.addEventListener("click", () => {
	hamburger.classList.toggle("active");
	nav_menu.classList.toggle("active");
	nav2_outer.classList.toggle("active");
})
document.querySelectorAll(".nav-link").forEach(n => n.addEventListener("click", () => {
	hamburger.classList.remove("active");
	nav_menu.classList.remove("active");
	nav2_outer.classList.remove("active");
}))

const hamburger_menu = document.querySelector(".hamburger_menu")
const nav_menu_mobile = document.querySelector(".main_mobile")
const nav_outer = document.querySelector(".responcive")
hamburger_menu.addEventListener("click", () => {
	hamburger_menu.classList.toggle("active");
	nav_menu_mobile.classList.toggle("active");
	nav_outer.classList.toggle("active");
})
document.querySelectorAll(".nav-link").forEach(n => n.addEventListener("click", () => {
	hamburger_menu.classList.remove("active");
	nav_menu_mobile.classList.remove("active");
	nav_outer.classList.remove("active");
}))

function myFunction() {
	var x = document.getElementById("myTopnav");
	if (x.className === "header-top") {
	  x.className += " respons_top";
	} else {
	  x.className = "header-top";
	}
  }
...
(function ($) {
	...
	// 	$('.main-header .navigation li.dropdown').append('<div class=" tajawal_black dropdown-btn"><i class=" fa fa-angle-down"></i></div>');
	// }
	...
	if ($('.banner-carousel').length) {
		$('.banner-carousel').owlCarousel({
			...
			navText: ['<span class=" tajawal_black fa fa-long-arrow-alt-left"></span>', '<span class=" tajawal_black fa fa-long-arrow-alt-right"></span>'],
			responsive: {
				0: {
					items: 1
				},
	...
	if ($('.services-carousel').length) {
		$('.services-carousel').owlCarousel({
			...
			smartSpeed: 700,
			autoplay: false,
			navText: ['<span class=" tajawal_black flaticon-left-chevron"></span>', '<span class=" tajawal_black flaticon-right-chevron"></span>'],
			responsive: {
				0: {
					items: 1
				},
	...
	if ($('.testimonial-carousel').length) {
		$('.testimonial-carousel').owlCarousel({
			...
			smartSpeed: 700,
			autoplay: 5000,
			navText: ['<span class=" tajawal_black far fa-arrow-left-long"></span>', '<span class=" tajawal_black far fa-arrow-right-long"></span>'],
			responsive: {
				0: {
					items: 1
				},
	...
	if ($('.clients-carousel').length) {
		$('.clients-carousel').owlCarousel({
			...
			smartSpeed: 400,
			autoplay: true,
			navText: ['<span class=" tajawal_black fa fa-angle-left"></span>', '<span class=" tajawal_black fa fa-angle-right"></span>'],
			responsive: {
				0: {
					items: 1
				},

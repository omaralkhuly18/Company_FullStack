...
!function(n) {
    ...
    function Lt(n) {
        ...
        var t = n.oClasses
          ...
          , o = n.oPreviousSearch
          , i = n.aanFeatures
          , l = '<input type="search" class=" tajawal_black ' + t.sFilterInput + '"/>'
    ...
    function Qt(n) {
        ...
        P(a).height(0)),
        k(function(t, e) {
            t.innerHTML = '<div class=" tajawal_black dataTables_sizing">' + F[e] + "</div>",
            t.childNodes[0].style.height = "0",
            t.childNodes[0].style.overflow = "hidden",
            t.style.width = A[e]
        }, e),
        C && k(function(t, e) {
            t.innerHTML = '<div class=" tajawal_black dataTables_sizing">' + L[e] + "</div>",
            t.childNodes[0].style.height = "0",
            t.childNodes[0].style.overflow = "hidden",
            t.style.width = I[e]
        }, a),
    ...
    function ae(t, e) {
        return t ? (e = (t = P("<div/>").css("width", M(t)).appendTo(e || v.body))[0].offsetWidth,
        t.remove(),
        e) : 0
    }
    function re(t, e) {
                ...
                function h(t, e) {
                    for (var n, a = b.sPageButtonDisabled, r = function(t) {
                        ...
                        Array.isArray(n)) {
                            ...
                            g = n) {
                            case "ellipsis":
                                t.append('<span class=" tajawal_black ellipsis">&#x2026;</span>');
                                break;
                            case "first":
                                p = m.sFirst,
                                0 === f && (s = !0);

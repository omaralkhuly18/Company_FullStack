...
!function(t, e) {
    ...
    const Ei = new Set(["sanitize", "allowList", "sanitizeFn"])
      ...
      , Ii = {
        ...
        sanitizeFn: null,
        selector: !1,
        template: '<div class=" tajawal_black tooltip" role="tooltip"><div class=" tajawal_black tooltip-arrow"></div><div class=" tajawal_black tooltip-inner"></div></div>',
        title: "",
        trigger: "hover focus"
    }
      , Di = {
    ...
    const Pi = {
        ...
        offset: [0, 8],
        placement: "right",
        template: '<div class=" tajawal_black popover" role="tooltip"><div class=" tajawal_black popover-arrow"></div><h3 class=" tajawal_black popover-header"></h3><div class=" tajawal_black popover-body"></div></div>',
        trigger: "click"
    }
      , xi = {
        ...Ni.DefaultType,

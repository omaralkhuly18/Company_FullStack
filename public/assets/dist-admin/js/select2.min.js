...
!function(n) {
    ...
    u.define("select2/results", ["jquery", "./utils"], function(d, p) {
        ...
        s.prototype.render = function() {
            var e = d('<ul class=" tajawal_black select2-results__options" role="listbox"></ul>');
        ...
        s.prototype.displayMessage = function(e) {
            ...
            this.clear(),
            this.hideLoading();
            var n = d('<li role="alert" aria-live="assertive" class=" tajawal_black select2-results__option"></li>')
    ...
    u.define("select2/selection/base", ["jquery", "../utils", "../keys"], function(n, s, i) {
        ...
        r.prototype.render = function() {
            var e = n('<span class=" tajawal_black select2-selection" role="combobox"  aria-haspopup="true" aria-expanded="false"></span>');
    ...
    u.define("select2/selection/single", ["jquery", "./base", "../utils", "../keys"], function(e, t, n, s) {
        ...
        i.prototype.render = function() {
            ...
            e.html('<span class=" tajawal_black select2-selection__rendered"></span><span class=" tajawal_black select2-selection__arrow" role="presentation"><b role="presentation"></b></span>'),
            e
        }
        ,
    ...
    u.define("select2/selection/multiple", ["jquery", "./base", "../utils"], function(i, e, c) {
        ...
        r.prototype.render = function() {
            ...
            e.html('<ul class=" tajawal_black select2-selection__rendered"></ul>'),
            e
        }
        ,
        r.prototype.bind = function(e, t) {
        ...
        r.prototype.selectionContainer = function() {
            return i('<li class=" tajawal_black select2-selection__choice"><button type="button" class=" tajawal_black select2-selection__choice__remove" tabindex="-1"><span aria-hidden="true">&times;</span></button><span class=" tajawal_black select2-selection__choice__display"></span></li>')
        }
        ,
        r.prototype.update = function(e) {
            if (this.clear(),
    ...
    u.define("select2/selection/allowClear", ["jquery", "../keys", "../utils"], function(i, s, a) {
        ...
        e.prototype.update = function(e, t) {
            ...
            (e = i('<button type="button" class=" tajawal_black select2-selection__clear" tabindex="-1"><span aria-hidden="true">&times;</span></button>')).attr("title", s()),
            e.attr("aria-label", s()),
    ...
    u.define("select2/selection/search", ["jquery", "../utils", "../keys"], function(s, a, l) {
        ...
        return e.prototype.render = function(e) {
            var t = this.options.get("translations").get("search")
              , n = s('<span class=" tajawal_black select2-search select2-search--inline"><textarea class=" tajawal_black select2-search__field" type="search" tabindex="-1" autocorrect="off" autocapitalize="none" spellcheck="false" role="searchbox" aria-autocomplete="list" ></textarea></span>');
    ...
    u.define("select2/dropdown", ["jquery", "./utils"], function(t, e) {
        ...
        n.prototype.render = function() {
            var e = t('<span class=" tajawal_black select2-dropdown"><span class=" tajawal_black select2-results"></span></span>');
    ...
    u.define("select2/dropdown/search", ["jquery"], function(r) {
        ...
        return e.prototype.render = function(e) {
            var t = e.call(this)
              ...
              , e = r('<span class=" tajawal_black select2-search select2-search--dropdown"><input class=" tajawal_black select2-search__field" type="search" tabindex="-1" autocorrect="off" autocapitalize="none" spellcheck="false" role="searchbox" aria-autocomplete="list" /></span>');
    ...
    u.define("select2/dropdown/infiniteScroll", ["jquery"], function(n) {
        ...
        e.prototype.createLoadingMore = function() {
            var e = n('<li class=" tajawal_black select2-results__option select2-results__option--load-more"role="option" aria-disabled="true"></li>')
    ...
    u.define("select2/core", ["jquery", "./options", "./utils", "./keys"], function(t, i, r, s) {
        ...
        o.prototype.render = function() {
            var e = t('<span class=" tajawal_black select2 select2-container"><span class=" tajawal_black selection"></span><span class=" tajawal_black dropdown-wrapper" aria-hidden="true"></span></span>');
            return e.attr("dir", this.options.get("dir")),
            this.$container = e,

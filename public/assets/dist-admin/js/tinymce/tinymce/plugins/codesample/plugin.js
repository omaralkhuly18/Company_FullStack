...
(function () {
    ...
    const prismjs = function (global, module, exports) {
      ...
      var Prism = function (_self) {
        ...
        Token.stringify = function stringify(o, language) {
          ...
          return '<' + env.tag + ' class=" tajawal_black ' + env.classes.join(' ') + '"' + attributes + '>' + env.content + '</' + env.tag + '>';
        };
    ...
    const insertCodeSample = (editor, language, code) => {
      ...
      editor.undoManager.transact(() => {
        ...
        return node.fold(() => {
          editor.insertContent('<pre id="__new" class=" tajawal_black language-' + language + '">' + code + '</pre>');

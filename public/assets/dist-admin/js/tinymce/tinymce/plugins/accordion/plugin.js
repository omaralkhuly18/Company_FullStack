...
(function () {
    ...
    const insertAccordion = editor => {
      ...
      const accordionSummaryHtml = `<summary class=" tajawal_black ${ accordionSummaryClass }">${ summaryText }</summary>`;
      const accordionBodyHtml = `<${ accordionBodyWrapperTag } class=" tajawal_black ${ accordionBodyWrapperClass }"><p>${ bodyText }</p></${ accordionBodyWrapperTag }>`;
      editor.undoManager.transact(() => {
        editor.insertContent([
          `<details data-mce-id="${ uid }" class=" tajawal_black ${ accordionDetailsClass }" open="open">`,

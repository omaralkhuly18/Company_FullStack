...
!function(a) {
    ...
    !function() {
        ...
        var e, f = Math.max, g = Math.abs, h = /left|center|right/, i = /top|center|bottom/, j = /[\+\-]\d+(\.[\d]+)?%?/, k = /^\w+/, l = /%$/, m = a.fn.pos;
        a.pos = {
        ...
        a.fn.pos = function(e) {
            ...
            e = a.extend({}, e);
            var l, n, o, p, q, r, s = a(e.of), t = a.pos.getWithinInfo(e.within), u = a.pos.getScrollInfo(t), v = (e.collision || "flip").split(" "), w = {};
            return r = d(s),
        ...
        a.ui.pos = {
            ...
            fit: {
                left: function(b, c) {
                    ...
                    var d, e = c.within, g = e.isWindow ? e.scrollLeft : e.offset.left, h = e.width, i = b.left - c.collisionPosition.marginLeft, j = g - i, k = i + c.collisionWidth - h - g;
                    c.collisionWidth > h ? j > 0 && k <= 0 ? (d = b.left + j + c.collisionWidth - h - g,
                    b.left += j - d) : b.left = k > 0 && j <= 0 ? g : j > k ? g + h - c.collisionWidth : g : j > 0 ? b.left += j : k > 0 ? b.left -= k : b.left = f(b.left - i, b.left),
                    a.ui.pos._trigger(b, c, "posCollided", "fitLeft")
                },
                top: function(b, c) {
                    a.ui.pos._trigger(b, c, "posCollide", "fitTop");
                    var d, e = c.within, g = e.isWindow ? e.scrollTop : e.offset.top, h = c.within.height, i = b.top - c.collisionPosition.marginTop, j = g - i, k = i + c.collisionHeight - h - g;
                    c.collisionHeight > h ? j > 0 && k <= 0 ? (d = b.top + j + c.collisionHeight - h - g,
                    b.top += j - d) : b.top = k > 0 && j <= 0 ? g : j > k ? g + h - c.collisionHeight : g : j > 0 ? b.top += j : k > 0 ? b.top -= k : b.top = f(b.top - i, b.top),
            ...
            flip: {
                left: function(b, c) {
                    ...
                    var d, e, f = c.within, h = f.offset.left + f.scrollLeft, i = f.width, j = f.isWindow ? f.scrollLeft : f.offset.left, k = b.left - c.collisionPosition.marginLeft, l = k - j, m = k + c.collisionWidth - i - j, n = "left" === c.my[0] ? -c.elemWidth : "right" === c.my[0] ? c.elemWidth : 0, o = "left" === c.at[0] ? c.targetWidth : "right" === c.at[0] ? -c.targetWidth : 0, p = -2 * c.offset[0];
                    l < 0 ? ((d = b.left + n + o + p + c.collisionWidth - i - h) < 0 || d < g(l)) && (b.left += n + o + p) : m > 0 && ((e = b.left - c.collisionPosition.marginLeft + n + o + p - j) > 0 || g(e) < m) && (b.left += n + o + p),
                    a.ui.pos._trigger(b, c, "posCollided", "flipLeft")
                },
                top: function(b, c) {
                    a.ui.pos._trigger(b, c, "posCollide", "flipTop");
                    var d, e, f = c.within, h = f.offset.top + f.scrollTop, i = f.height, j = f.isWindow ? f.scrollTop : f.offset.top, k = b.top - c.collisionPosition.marginTop, l = k - j, m = k + c.collisionHeight - i - j, n = "top" === c.my[1], o = n ? -c.elemHeight : "bottom" === c.my[1] ? c.elemHeight : 0, p = "top" === c.at[1] ? c.targetHeight : "bottom" === c.at[1] ? -c.targetHeight : 0, q = -2 * c.offset[1];
                    l < 0 ? ((e = b.top + o + p + q + c.collisionHeight - i - h) < 0 || e < g(l)) && (b.top += o + p + q) : m > 0 && ((d = b.top - c.collisionPosition.marginTop + o + p + q - j) > 0 || g(d) < m) && (b.top += o + p + q),
...
function(a) {
    ...
    var b = {
      ...
      , c = function(d, e) {
        ...
        this.container = !!b.isElement(this.options.container) && a(this.options.container),
        !1 === this.container && (this.element.is(".dropdown-toggle") ? this.container = a("~ .dropdown-menu:first", this.element) : this.container = this.element.is("input,textarea,button,.btn") ? this.element.parent() : this.element),
        ...
        !1 === this.input && (this.input = this.container.find(this.options.input),
    ...
    c.defaultOptions = {
        ...
        templates: {
            popover: '<div class=" tajawal_black iconpicker-popover popover"><div class=" tajawal_black arrow"></div><div class=" tajawal_black popover-title"></div><div class=" tajawal_black popover-content"></div></div>',
            footer: '<div class=" tajawal_black popover-footer"></div>',
            buttons: '<button class=" tajawal_black iconpicker-btn iconpicker-btn-cancel btn btn-default btn-sm">Cancel</button> <button class=" tajawal_black iconpicker-btn iconpicker-btn-accept btn btn-primary btn-sm">Accept</button>',
            search: '<input type="search" class=" tajawal_black form-control iconpicker-search" placeholder="Type to filter" />',
            iconpicker: '<div class=" tajawal_black iconpicker"><div class=" tajawal_black iconpicker-items"></div></div>',
            iconpickerItem: '<a role="button" href="#" class=" tajawal_black iconpicker-item"><i></i></a>'
        }
    },
    ...
    c.prototype = {
        ...
        _createPopover: function() {
            ...
            if (this.options.title && c.append(a('<div class=" tajawal_black popover-title-text">' + this.options.title + "</div>")),
            ...
            return !0 === this.options.animation && this.popover.addClass("fade"),
            this.popover
        },
        _createIconpicker: function() {
            ...
            var c = function(c) {
                ...
                !1 === b.options.mustAccept ? (b.update(d.data("iconpickerValue")),
            ...
            for (var d in this.options.icons)
                if ("string" == typeof this.options.icons[d].title) {
                    ...
                    if (e.find("i").addClass(this.options.fullClassFormatter(this.options.icons[d].title)),
                    ...
                    this.options.icons[d].searchTerms.length > 0) {
                        for (var f = "", g = 0; g < this.options.icons[d].searchTerms.length; g++)
        ...
        _bindElementEvents: function() {
            ...
            this.hasInput() && this.input.on("keyup.iconpicker", function(d) {
                b.inArray(d.keyCode, [38, 40, 37, 39, 16, 17, 18, 9, 8, 91, 93, 20, 46, 186, 190, 46, 78, 188, 44, 86]) ? c._updateFormGroupStatus(!1 !== c.getValid(this.value)) : c.update(),
                !0 === c.options.inputSearch && c.filter(a(this).val().toLowerCase())
            })
        },
        ...
        _updateFormGroupStatus: function(a) {
            return !!this.hasInput() && (!1 !== a ? this.input.parents(".form-group:first").removeClass("has-error") : this.input.parents(".form-group:first").addClass("has-error"),
            !0)
        },
        getValid: function(c) {
            b.isString(c) || (c = "");
        ...
        setValue: function(a) {
            ...
            return !1 !== b ? (this.iconpickerValue = b,
        ...
        setSourceValue: function(a) {
            ...
            !1 !== a && "" !== a && (this.hasInput() ? this.input.val(this.iconpickerValue) : this.element.data("iconpickerValue", this.iconpickerValue),
        ...
        filter: function(c) {
            if (b.isEmpty(c))
                return this.iconpicker.find(".iconpicker-item").show(),
                a(!1);
            var d = [];
        ...
        update: function(a, b) {
            return a = a || this.getSourceValue(this.iconpickerValue),
            this._trigger("iconpickerUpdate", {
                iconpickerValue: this.iconpickerValue
            }),
            !0 === b ? a = this.setValue(a) : (a = this.setSourceValue(a),

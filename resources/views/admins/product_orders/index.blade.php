                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class=" tajawal_black sorting" tabindex="0" aria-controls="dtable" rowspan="1"
                                                ...
                                                style="width: 323.953px;">{{ trans('web_trans.product') }}</th>

                                            <th class=" tajawal_black sorting" tabindex="0" aria-controls="dtable" rowspan="1"
                                                colspan="1" aria-label="Quantity: activate to sort column ascending"
                                                style="width: 323.953px;">{{ trans('web_trans.amount') }}</th>
                                        ...
                                        @foreach ($Orders as $Order)
                                            <tr class=" tajawal_black odd">
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <form method="POST"
                                                            action="{{ route('dash.product.order.approved', ['id' => $Order->id]) }}">
                                                            @csrf
                                                            @method('PUT')
                                                ...
                                                <td>
                                                    <div class=" tajawal_black btn-group" role="group">
                                                        <form method="POST"
                                                            action="{{ route('dash.product.order.delete', ['id' => $Order->id]) }}">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" class=" tajawal_black btn btn-danger btn-sm"

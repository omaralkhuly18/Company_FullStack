...
@section('title')
    {{ trans('web_trans.update_pricing_plan') }}
@endsection
@section('css')
@endsection
...
@section('content')
    <div class=" tajawal_black container-fluid">
        ...
        <div class=" tajawal_black d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class=" tajawal_black h3 mb-0 text-gray-800">Edit Pricing Plan</h1>
        ...
        <div class=" tajawal_black card shadow mb-4">
            <div class=" tajawal_black card-body">
                <form action="{{ route('dash.price.update') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                                        ...
                                        <div class=" tajawal_black col-md-6">
                                            <div class=" tajawal_black mb-3">
                                                ...
                                                <input type="text" name="name_ar" class=" tajawal_black form-control"
                                                    value="{{ $PricingPlan->name_ar }}" autocomplete="off" required>
                                                @error('name_ar')
                                        ...
                                        <div class=" tajawal_black col-md-6">
                                            <div class=" tajawal_black mb-3">
                                                ...
                                                <input type="text" name="button_text_ar" class=" tajawal_black form-control"
                                                    value="{{ $PricingPlan->btn_text_ar }}" autocomplete="off" required>
                                                @error('btn_text_ar')
                                        ...
                                        <div class=" tajawal_black col-md-4">
                                            <div class=" tajawal_black mb-3">
                                                ...
                                                <input type="text" name="name" class=" tajawal_black form-control"
                                                    value="{{ $PricingPlan->name }}" autocomplete="off" required>
                                                @error('name')
                                        ...
                                        <div class=" tajawal_black col-md-4">
                                            <div class=" tajawal_black mb-3">
                                                <label for="" class=" tajawal_black form-label">{{ trans('web_trans.price') }}
                                                    *</label>
                                                <input type="number" name="price" class=" tajawal_black form-control"
                                                    value="{{ $PricingPlan->price }}" autocomplete="off" required>
                                                @error('price')
                                        ...
                                        <div class=" tajawal_black col-md-4">
                                            <div class=" tajawal_black mb-3">
                                                <label for="" class=" tajawal_black form-label">{{ trans('web_trans.period') }}
                                                    *</label>
                                                <input type="text" name="period" class=" tajawal_black form-control"
                                                    value="{{ $PricingPlan->period }}" autocomplete="off" required>
                                                @error('period')
                                        ...
                                        <div class=" tajawal_black col-md-6">
                                            <div class=" tajawal_black mb-3">
                                                ...
                                                <input type="text" name="button_text" class=" tajawal_black form-control"
                                                    value="{{ $PricingPlan->btn_text }}" autocomplete="off" required>
                                                @error('button_text')
                                        ...
                                        <div class=" tajawal_black col-md-6">
                                            <div class=" tajawal_black mb-3">
                                                ...
                                                <input type="text" name="button_url" class=" tajawal_black form-control"
                                                    value="{{ $PricingPlan->btn_url }}" autocomplete="off" required>
                                                @error('button_url')
                    ...
                    <br>
                    <button type="submit"
                        class=" tajawal_black btn btn-success mb-50 btn-common">{{ trans('web_trans.update_item_btn') }}</button>
                </form>
            </div>
        </div>

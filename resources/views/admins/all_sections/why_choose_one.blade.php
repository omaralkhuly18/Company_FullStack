...
@section('content')
    <div class=" tajawal_black container-fluid">
        ...
        <div class=" tajawal_black d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class=" tajawal_black h3 mb-0 text-gray-800">{{ trans('web_trans.choose_one') }}</h1>
        </div>
        ...
        <div class=" tajawal_black row">
            <div class=" tajawal_black col-md-7">
                <div class=" tajawal_black card shadow mb-4">
                    <div class=" tajawal_black card-body">
                        <form action="{{ route('dash.choose.one.update') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class=" tajawal_black mb-3">
                                ...
                                <input type="text" name="heading" class=" tajawal_black form-control"
                                    value="{{ $WhyChooseOne->heading }}" autocomplete="off">
                            </div>
                            <div class=" tajawal_black mb-3">
                                ...
                                <input type="text" name="heading_ar" class=" tajawal_black form-control"
                                    value="{{ $WhyChooseOne->heading_ar }}" autocomplete="off">
                            </div>
                            <div class=" tajawal_black mb-3">
                                ...
                                <input type="text" name="subheading" class=" tajawal_black form-control"
                                    value="{{ $WhyChooseOne->subheading }}" autocomplete="off">
                            </div>
                            <div class=" tajawal_black mb-3">
                                ...
                                <input type="text" name="subheading_ar" class=" tajawal_black form-control"
                                    value="{{ $WhyChooseOne->subheading_ar }}" autocomplete="off">
                            </div>
                            <div class=" tajawal_black mb-3">
                                <label for="" class=" tajawal_black form-label">{{ trans('web_trans.text') }}</label>
                                <textarea name="text" class=" tajawal_black form-control h_100" cols="30" rows="10" autocomplete="off">{{ $WhyChooseOne->text }}</textarea>
                            </div>
                            <div class=" tajawal_black mb-3">
                                <label for="" class=" tajawal_black form-label">{{ trans('web_trans.text_ar') }}</label>
                                <textarea name="text_ar" class=" tajawal_black form-control h_100" cols="30" rows="10" autocomplete="off">{{ $WhyChooseOne->text_ar }}</textarea>
                            </div>
                            <div class=" tajawal_black row">
                                <div class=" tajawal_black col-md-4">
                                    <div class=" tajawal_black mb-3">
                                        ...
                                        <div class=" tajawal_black photo-container">
                                            <a href="{{ asset('assets/uploads/All_Sections/choose_one/' . $WhyChooseOne->photo) }}"
                                                class=" tajawal_black magnific"><img
                                                    src="{{ asset('assets/uploads/All_Sections/choose_one/' . $WhyChooseOne->photo) }}"
                                                    alt=""></a>
                                        </div>
                                    </div>
                                    <div class=" tajawal_black mb-3">
            ...
            <div class=" tajawal_black col-md-5">
                <div class=" tajawal_black card shadow mb-4">
                    <div class=" tajawal_black card-body">
                        <h4><b>{{ trans('web_trans.choose_one_element') }}</b></h4>
                            ...
                            <div class=" tajawal_black modal-dialog modal-dialog-centered">
                                <div class=" tajawal_black modal-content">
                                    ...
                                    <div class=" tajawal_black modal-body">
                                        <form action="{{ route('dash.choose.one.element.store') }}" method="post">
                                            @csrf
                                            <input type="hidden" name="add_id" value="{{ $WhyChooseOne->id }}">
                                            <div class=" tajawal_black mb-3">
                                                <label for=""
                            ...
                            <div class=" tajawal_black modal fade" id="edit_modal_1" tabindex="-1" aria-labelledby="exampleModalLabel"
                                ...
                                <div class=" tajawal_black modal-dialog modal-dialog-centered">
                                    <div class=" tajawal_black modal-content">
                                        ...
                                        <div class=" tajawal_black modal-body">
                                            <form action="{{ route('dash.choose.one.element.update') }}" method="post">
                                                @csrf
                                                @method('PUT')
                            ...
                            <table class=" tajawal_black table table-bordered table-sm">
                                ...
                                <tbody>
                                    @foreach ($WhyChooseOneElements as $WhyChooseOneElement)
                                        <tr>
                                            <td>
                                                <i class="{{ $WhyChooseOneElement->icon }} fz_40"></i>
                                            </td>
                                            @if ($app->getLocale() == 'ar')
                                                <td>{{ $WhyChooseOneElement->heading_ar }}</td>
                                            @else
                                                <td>{{ $WhyChooseOneElement->heading }}</td>
                                            @endif
                                            <td>
                                                <div class=" tajawal_black btn-group" role="group">
                                                    <a href="" class=" tajawal_black btn btn-primary btn-sm btn-block edit-option"
                                                        ...
                                                        data-update_id="{{ $WhyChooseOneElement->id }}"
                                                        data-icon="{{ $WhyChooseOneElement->icon }}"
                                                        data-heading="{{ $WhyChooseOneElement->heading }}"
                                                        data-heading_ar="{{ $WhyChooseOneElement->heading_ar }}"><i
                                                            class=" tajawal_black fas fa-edit"></i></a>
                                                    <span style="color: white">s</span>
                                                    <form method="POST"
                                                        action="{{ route('dash.choose.one.element.delete', ['id' => $WhyChooseOneElement->id]) }}">
                                                        @csrf
                                                        @method('DELETE')

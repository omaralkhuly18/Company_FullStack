...
@section('title')
    {{ trans('web_trans.update_category') }}
@endsection
...
@section('content')
    <div class=" tajawal_black container-fluid">
        ...
        <div class=" tajawal_black d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class=" tajawal_black h3 mb-0 text-gray-800">{{ trans('web_trans.update_category') }}</h1>
            <a href="{{ route('dash.product.category.index') }}" class=" tajawal_black d-none d-sm-inline-block btn btn-primary shadow-sm"><i
        ...
        <div class=" tajawal_black card shadow mb-4">
            <div class=" tajawal_black card-body">
                <form action="{{ route('dash.product.category.update') }}" method="post">
                    @csrf
                    @method('PUT')
                                ...
                                <div class=" tajawal_black accordion-body">
                                        ...
                                        <div class=" tajawal_black col-md-6">
                                            <div class=" tajawal_black mb-3">
                                                ...
                                                <input type="text" name="name_ar" class=" tajawal_black form-control"
                                                    value="{{ $ProductCategory->name_ar }}" autocomplete="off">
                                                @error('name_ar')
                                        ...
                                        <div class=" tajawal_black col-md-6">
                                            <div class=" tajawal_black mb-3">
                                                ...
                                                <input type="text" name="slug_ar" class=" tajawal_black form-control"
                                                    value="{{ $ProductCategory->slug_ar }}" autocomplete="off">
                                                @error('slug_ar')
                                    ...
                                    <div class=" tajawal_black mb-3">
                                        ...
                                        <input type="text" name="seo_title" class=" tajawal_black form-control"
                                            value="{{ $ProductCategory->seo_title_ar }}" autocomplete="off">
                                    </div>
                                    <div class=" tajawal_black mb-3">
                                        <label for="" class=" tajawal_black form-label">SEO
                                            {{ trans('web_trans.description') }}</label>
                                        <textarea name="seo_meta_description" class=" tajawal_black form-control h_100" cols="30" rows="10" autocomplete="off">{{ $ProductCategory->seo_descr_ar }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class=" tajawal_black accordion-body">
                                    <div class=" tajawal_black mb-3">
                                        ...
                                        <input type="text" name="name" class=" tajawal_black form-control"
                                            value="{{ $ProductCategory->name }}" autocomplete="off">
                                        @error('name')
                                    ...
                                    <div class=" tajawal_black mb-3">
                                        ...
                                        <input type="text" name="slug" class=" tajawal_black form-control"
                                            value="{{ $ProductCategory->slug }}" autocomplete="off">
                                        @error('slug_ar')
                                            @foreach ($errors->get('slug_ar') as $error)
                                                <div class=" tajawal_black text-danger">{{ $error }}</div>
                                            @endforeach
                                    ...
                                    <div class=" tajawal_black mb-3">
                                        ...
                                        <input type="text" name="seo_title" class=" tajawal_black form-control"
                                            value="{{ $ProductCategory->seo_title }}" autocomplete="off">
                                    </div>
                                    <div class=" tajawal_black mb-3">
                                        <label for="" class=" tajawal_black form-label">SEO
                                            {{ trans('web_trans.description') }}</label>
                                        <textarea name="seo_meta_description" class=" tajawal_black form-control h_100" cols="30" rows="10" autocomplete="off">{{ $ProductCategory->seo_descr }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>

...
@section('content')
    <div class=" tajawal_black container-fluid">
        ...
        <div class=" tajawal_black d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class=" tajawal_black h3 mb-0 text-gray-800">{{ trans('web_trans.create_post') }}</h1>
        ...
        <div class=" tajawal_black card shadow mb-4">
            <div class=" tajawal_black card-body">
                <form action="{{ route('dash.post.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                                        ...
                                        <div class=" tajawal_black col-md-6">
                                            <div class=" tajawal_black mb-3">
                                                <label for="" class=" tajawal_black form-label">{{ trans('web_trans.title') }}
                                                    *</label>
                                                <input type="text" name="title_ar" class=" tajawal_black form-control" value=""
                                                    autocomplete="off">
                                                @error('title_ar')
                                    ...
                                    <div class=" tajawal_black row">
                                        <div class=" tajawal_black col-md-6">
                                            <div class=" tajawal_black mb-3">
                                                <label for="" class=" tajawal_black form-label">{{ trans('web_trans.title') }}
                                                    *</label>
                                                <input type="text" name="title" class=" tajawal_black form-control" value=""

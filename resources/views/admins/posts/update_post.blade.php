...
@section('content')
    <div class=" tajawal_black container-fluid">
        ...
        <div class=" tajawal_black d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class=" tajawal_black h3 mb-0 text-gray-800">{{ trans('web_trans.update_post') }}</h1>
            <a href="{{ route('dash.post.index') }}" class=" tajawal_black d-none d-sm-inline-block btn btn-primary shadow-sm"><i
        ...
        <div class=" tajawal_black card shadow mb-4">
            <div class=" tajawal_black card-body">
                <form action="{{ route('dash.post.update') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                                ...
                                <div class=" tajawal_black accordion-body">
                                    <div class=" tajawal_black row">
                                        <div class=" tajawal_black col-md-6">
                                            <div class=" tajawal_black mb-3">
                                                <label for="" class=" tajawal_black form-label">{{ trans('web_trans.title') }}
                                                    *</label>
                                                <input type="text" name="title_ar" class=" tajawal_black form-control"
                                                    value="{{ $Post->title_ar }}" autocomplete="off">
                                                @error('title_ar')
                                                    @foreach ($errors->get('title_ar') as $error)
                                        ...
                                        <div class=" tajawal_black col-md-6">
                                            <div class=" tajawal_black mb-3">
                                                ...
                                                <input type="text" name="slug_ar" class=" tajawal_black form-control"
                                                    value="{{ $Post->slug_ar }}" autocomplete="off">
                                                @error('slug_ar')
                                    ...
                                    <div class=" tajawal_black mb-3">
                                        ...
                                        <textarea name="description_ar" class=" tajawal_black form-control editor" cols="30" rows="10" autocomplete="off"
                                            id="mce_0">{{ $Post->descr_ar }}</textarea>
                                    ...
                                    <div class=" tajawal_black mb-3">
                                        ...
                                        <input type="text" name="seo_title_ar" class=" tajawal_black form-control"
                                            value="{{ $Post->seo_title_ar }}" autocomplete="off">
                                    </div>
                                    <div class=" tajawal_black mb-3">
                                        <label for="" class=" tajawal_black form-label">SEO
                                            {{ trans('web_trans.description') }}</label>
                                        <textarea name="seo_meta_description_ar" class=" tajawal_black form-control h_100" cols="30" rows="10" autocomplete="off">{{ $Post->seo_descr_ar }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class=" tajawal_black accordion-body">
                                    <div class=" tajawal_black row">
                                        <div class=" tajawal_black col-md-6">
                                            <div class=" tajawal_black mb-3">
                                                <label for="" class=" tajawal_black form-label">{{ trans('web_trans.title') }}
                                                    *</label>
                                                <input type="text" name="title" class=" tajawal_black form-control"
                                        ...
                                        <div class=" tajawal_black col-md-6">
                                            <div class=" tajawal_black mb-3">
                                                ...
                                                <input type="text" name="slug" class=" tajawal_black form-control"
                                                    value="{{ $Post->slug }}" autocomplete="off" required>
                                                @error('slug')
                                    ...
                                    <div class=" tajawal_black row">
                                        <div class=" tajawal_black col-md-6">
                                            <div class=" tajawal_black mb-3">
                                                ...
                                                <select name="post_category_id" class=" tajawal_black form-select" autocomplete="off"
                                                    required>
                                                    @foreach ($Categories as $Category)
                                                        <option value="{{ $Category->id }}"
                                                            {{ $Category->id == $Post->postCategory->id ? 'selected' : '' }}>
                                                            {{ $Category->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class=" tajawal_black col-md-6">
                                            <div class=" tajawal_black mb-3">
                                                <label>{{ trans('web_trans.tags') }}</label>
                                                <select name="tags[]"
                                                    class=" tajawal_black form-select select2_tags select2-hidden-accessible"
                                                    autocomplete="off" data-select2-id="select2-data-1-l475"
                                    ...
                                    <div class=" tajawal_black mb-3">
                                        ...
                                        <input type="text" name="seo_title" class=" tajawal_black form-control"
                                            value="{{ $Post->seo_title }}" autocomplete="off">
                                    </div>
                                    <div class=" tajawal_black mb-3">
                                        <label for="" class=" tajawal_black form-label">SEO
                                            {{ trans('web_trans.description') }}</label>
                                        <textarea name="seo_meta_description" class=" tajawal_black form-control h_100" cols="30" rows="10" autocomplete="off">{{ $Post->seo_descr }}</textarea>
                                    </div>
                                    <div class=" tajawal_black row">
                                        <div class=" tajawal_black col-md-4">
                                            <div class=" tajawal_black mb-3">
                                                ...
                                                <div class=" tajawal_black photo-container">
                                                    <img src="{{ asset('assets/uploads/posts/' . $Post->photo) }}"
                                                        alt="">
                                                </div>
                                            </div>
                                            <div class=" tajawal_black mb-3">

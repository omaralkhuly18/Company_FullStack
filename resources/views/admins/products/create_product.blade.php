...
@section('title')
    {{ trans('web_trans.create_product') }}
@endsection
...
@section('content')
    <div class=" tajawal_black container-fluid">
        ...
        <div class=" tajawal_black d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class=" tajawal_black h3 mb-0 text-gray-800">{{ trans('web_trans.create_product') }}</h1>
        ...
        <div class=" tajawal_black card shadow mb-4">
            <div class=" tajawal_black card-body">
                <form action="{{ route('dash.product.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                                    ...
                                    <div class=" tajawal_black row">
                                        <div class=" tajawal_black col-md-4">
                                            <div class=" tajawal_black mb-3">
                                                ...
                                                <input type="text" name="amount" class=" tajawal_black form-control" value=""
                                                    autocomplete="off" required>
                                                @error('amount')
                                        ...
                                        <div class=" tajawal_black col-md-4">
                                            <div class=" tajawal_black mb-3">
                                                ...
                                                <input type="text" name="price" class=" tajawal_black form-control" value=""
                                                    autocomplete="off" required>
                                                @error('price')

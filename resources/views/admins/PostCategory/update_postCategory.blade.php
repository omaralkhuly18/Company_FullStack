    ...
    <div class=" tajawal_black container-fluid">
        ...
        <div class=" tajawal_black card shadow mb-4">
            <div class=" tajawal_black card-body">
                <form action="{{ route('dash.category.update') }}" method="post">
                    @csrf
                    @method('PUT')
                                ...
                                <div class=" tajawal_black accordion-body">
                                        ...
                                        <div class=" tajawal_black col-md-6">
                                            <div class=" tajawal_black mb-3">
                                                ...
                                                <input type="text" name="name_ar" class=" tajawal_black form-control"
                                                    value="{{ $PostCategory->name_ar }}" autocomplete="off">
                                                @error('name_ar')
                                        ...
                                        <div class=" tajawal_black col-md-6">
                                            <div class=" tajawal_black mb-3">
                                                ...
                                                <input type="text" name="slug_ar" class=" tajawal_black form-control"
                                                    value="{{ $PostCategory->slug_ar }}" autocomplete="off">
                                                @error('slug_ar')
                                    ...
                                    <div class=" tajawal_black mb-3">
                                        ...
                                        <input type="text" name="seo_title" class=" tajawal_black form-control"
                                            value="{{ $PostCategory->seo_title_ar }}" autocomplete="off">
                                    </div>
                                    <div class=" tajawal_black mb-3">
                                        <label for="" class=" tajawal_black form-label">SEO
                                            {{ trans('web_trans.description') }}</label>
                                        <textarea name="seo_meta_description" class=" tajawal_black form-control h_100" cols="30" rows="10" autocomplete="off">{{ $PostCategory->seo_descr_ar }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class=" tajawal_black accordion-body">
                                    <div class=" tajawal_black mb-3">
                                        ...
                                        <input type="text" name="name" class=" tajawal_black form-control"
                                            value="{{ $PostCategory->name }}" autocomplete="off">
                                        @error('name')
                                    ...
                                    <div class=" tajawal_black mb-3">
                                        ...
                                        <input type="text" name="slug" class=" tajawal_black form-control"
                                            value="{{ $PostCategory->slug }}" autocomplete="off">
                                        @error('slug_ar')
                                            @foreach ($errors->get('slug_ar') as $error)
                                                <div class=" tajawal_black text-danger">{{ $error }}</div>
                                            @endforeach
                                    ...
                                    <div class=" tajawal_black mb-3">
                                        ...
                                        <input type="text" name="seo_title" class=" tajawal_black form-control"
                                            value="{{ $PostCategory->seo_title }}" autocomplete="off">
                                    </div>
                                    <div class=" tajawal_black mb-3">
                                        <label for="" class=" tajawal_black form-label">SEO
                                            {{ trans('web_trans.description') }}</label>
                                        <textarea name="seo_meta_description" class=" tajawal_black form-control h_100" cols="30" rows="10" autocomplete="off">{{ $PostCategory->seo_descr }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>

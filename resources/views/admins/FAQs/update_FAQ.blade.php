...
@section('content')
    <div class=" tajawal_black container-fluid">
        ...
        <div class=" tajawal_black d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class=" tajawal_black h3 mb-0 text-gray-800">{{ trans('web_trans.update_FAQs') }}</h1>
        ...
        <div class=" tajawal_black card shadow mb-4">
            <div class=" tajawal_black card-body">
                <form action="{{ route('dash.FAQ.update') }}" method="post">
                    @csrf
                    @method('PUT')
                            ...
                            <div id="collapseOne" class=" tajawal_black accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class=" tajawal_black accordion-body">
                                    <div class=" tajawal_black mb-3">
                                        ...
                                        <input type="text" name="question_ar" class=" tajawal_black form-control"
                                            value="{{ $FAQ->question_ar }}" autocomplete="off" required>
                                        @error('question_ar')
                                    ...
                                    <div class=" tajawal_black mb-3">
                                        ...
                                        <textarea name="answer_ar" class=" tajawal_black form-control editor" cols="30" rows="10" autocomplete="off" id="mce_0">{{ $FAQ->answer_ar }}</textarea>
                                        @error('answer_ar')
                            ...
                            <div id="collapseTwo" class=" tajawal_black accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class=" tajawal_black accordion-body">
                                    <div class=" tajawal_black mb-3">
                                        ...
                                        <input type="text" name="question" class=" tajawal_black form-control"
                                            value="{{ $FAQ->question }}" autocomplete="off" required>
                                    </div>
                                    <div class=" tajawal_black mb-3">
                                        <label for="" class=" tajawal_black form-label">{{ trans('web_trans.answer') }}*</label>
                                        <textarea name="answer" class=" tajawal_black form-control editor" cols="30" rows="10" autocomplete="off" id="mce_0">{{ $FAQ->answer }}</textarea>

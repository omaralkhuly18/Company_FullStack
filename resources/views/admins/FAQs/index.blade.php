...
@section('content')
    <div class=" tajawal_black container-fluid">
        ...
        <div class=" tajawal_black d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ route('dash.FAQ.create') }}" class=" tajawal_black d-none d-sm-inline-block btn btn-primary shadow-sm"><i
                    class=" tajawal_black fas fa-plus"></i>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class=" tajawal_black sorting" tabindex="0" aria-controls="dtable" rowspan="1"
                                                ...
                                                style="width: 744.375px;">{{ trans('web_trans.question') }}</th>
                                            <th class=" tajawal_black sorting" tabindex="0" aria-controls="dtable" rowspan="1"
                                                colspan="1" aria-label="Action: activate to sort column ascending"
                                                style="width: 114.641px;">{{ trans('web_trans.actions') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($FAQs as $FAQ)
                                            <tr class=" tajawal_black odd">
                                                ...
                                                <td>
                                                    <div class=" tajawal_black btn-group" role="group">
                                                        ...
                                                        <a href="{{ route('dash.FAQ.show.update', ['id' => $FAQ->id]) }}"
                                                            class=" tajawal_black btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                                        <span style="color: white">s</span>
                                                        <form method="POST"
                                                            action="{{ route('dash.FAQ.delete', ['id' => $FAQ->id]) }}">
                                                            @csrf
                                                            @method('DELETE')

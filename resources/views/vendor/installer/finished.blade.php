...
@section('container')
    ...
    <div class=" tajawal_black buttons">
        <a href="{{ url('/') }}" class=" tajawal_black button">{{ trans('installer_messages.final.home') }}</a>
		<a href="{{ url('admin/') }}" class=" tajawal_black button">{{ trans('installer_messages.final.dash') }}</a>
    </div>

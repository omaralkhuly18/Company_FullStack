...
@section('container')
    <div class=" tajawal_black tabs tabs-full">

        <input id="tab1" type="radio" name="tabs" class=" tajawal_black tab-input" checked />
        <label for="tab1" class=" tajawal_black tab-label">
            <i class="fa fa-cog fa-2x fa-fw" aria-hidden="true"></i>
            <br />
            {{ trans('installer_messages.environment.wizard.tabs.environment') }}
        </label>

        <input id="tab2" type="radio" name="tabs" class=" tajawal_black tab-input" />
        <label for="tab2" class=" tajawal_black tab-label">
            <i class="fa fa-database fa-2x fa-fw" aria-hidden="true"></i>
            <br />
            {{ trans('installer_messages.environment.wizard.tabs.database') }}
        </label>

        <input id="tab3" type="radio" name="tabs" class=" tajawal_black tab-input" />
        <label for="tab3" class=" tajawal_black tab-label">
            <i class="fa fa-cogs fa-2x fa-fw" aria-hidden="true"></i>
            <br />
            {{ trans('installer_messages.environment.wizard.tabs.application') }}
        </label>

        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class=" tajawal_black tabs-wrap">
            <div class=" tajawal_black tab" id="tab1content">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">

                <div class=" tajawal_black form-group {{ $errors->has('app_name') ? ' has-error ' : '' }}">
                    <label for="app_name">
                    ...
                    @if ($errors->has('app_name'))
                        <span class=" tajawal_black error-block">
                ...
                <div class=" tajawal_black form-group {{ $errors->has('environment') ? ' has-error ' : '' }}">
                ...
                <div class=" tajawal_black form-group {{ $errors->has('app_debug') ? ' has-error ' : '' }}">
                    <label for="app_debug">
                ...
                <div class=" tajawal_black form-group {{ $errors->has('app_log_level') ? ' has-error ' : '' }}">
                ...
                <div class=" tajawal_black form-group {{ $errors->has('app_url') ? ' has-error ' : '' }}">
                    <label for="app_url">
                ...
                <div class=" tajawal_black buttons">
                    <button class=" tajawal_black button" onclick="showDatabaseSettings();return false">
                        {{ trans('installer_messages.environment.wizard.form.buttons.setup_database') }}
                        <i class="fa fa-angle-right fa-fw" aria-hidden="true"></i>
                    </button>
                </div>
            </div>
            <div class=" tajawal_black tab" id="tab2content">

                <div class=" tajawal_black form-group {{ $errors->has('database_connection') ? ' has-error ' : '' }}">
                ...
                <div class=" tajawal_black form-group {{ $errors->has('database_hostname') ? ' has-error ' : '' }}">
                ...
                <div class=" tajawal_black form-group {{ $errors->has('database_port') ? ' has-error ' : '' }}">
                ...
                <div class=" tajawal_black form-group {{ $errors->has('database_name') ? ' has-error ' : '' }}">
                ...
                <div class=" tajawal_black form-group {{ $errors->has('database_username') ? ' has-error ' : '' }}">
                ...
                <div class=" tajawal_black form-group {{ $errors->has('database_password') ? ' has-error ' : '' }}">
                ...
                <div class=" tajawal_black buttons">
                    <button class=" tajawal_black button" onclick="showApplicationSettings();return false">
                        {{ trans('installer_messages.environment.wizard.form.buttons.setup_application') }}
                        <i class="fa fa-angle-right fa-fw" aria-hidden="true"></i>
                    </button>
                </div>
            </div>
            <div class=" tajawal_black tab" id="tab3content">
                <div class=" tajawal_black block">
                    ...
                    <div class=" tajawal_black info">
                        <div class=" tajawal_black form-group {{ $errors->has('broadcast_driver') ? ' has-error ' : '' }}">
                            <label for="broadcast_driver">{{ trans('installer_messages.environment.wizard.form.app_tabs.broadcasting_label') }}
                                <sup>
                                    <a href="https://laravel.com/docs/5.4/broadcasting" target="_blank" title="{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}">
                                        ...
                                        <span class=" tajawal_black sr-only">{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}</span>
                                    </a>
                                </sup>
                            </label>
                        ...
                        <div class=" tajawal_black form-group {{ $errors->has('cache_driver') ? ' has-error ' : '' }}">
                        ...
                        <div class=" tajawal_black form-group {{ $errors->has('session_driver') ? ' has-error ' : '' }}">
                        ...
                        <div class=" tajawal_black form-group {{ $errors->has('queue_driver') ? ' has-error ' : '' }}">
                ...
                <div class=" tajawal_black block">
                    ...
                    <div class=" tajawal_black info">
                        <div class=" tajawal_black form-group {{ $errors->has('redis_hostname') ? ' has-error ' : '' }}">
                        ...
                        <div class=" tajawal_black form-group {{ $errors->has('redis_password') ? ' has-error ' : '' }}">
                        ...
                        <div class=" tajawal_black form-group {{ $errors->has('redis_port') ? ' has-error ' : '' }}">
                ...
                <div class=" tajawal_black block">
                    ...
                    <div class=" tajawal_black info">
                        <div class=" tajawal_black form-group {{ $errors->has('mail_driver') ? ' has-error ' : '' }}">
                        ...
                        <div class=" tajawal_black form-group {{ $errors->has('mail_host') ? ' has-error ' : '' }}">
                        ...
                        <div class=" tajawal_black form-group {{ $errors->has('mail_port') ? ' has-error ' : '' }}">
                        ...
                        <div class=" tajawal_black form-group {{ $errors->has('mail_username') ? ' has-error ' : '' }}">
                        ...
                        <div class=" tajawal_black form-group {{ $errors->has('mail_password') ? ' has-error ' : '' }}">
                        ...
                        <div class=" tajawal_black form-group {{ $errors->has('mail_encryption') ? ' has-error ' : '' }}">
                ...
                <div class=" tajawal_black block margin-bottom-2">
                    ...
                    <div class=" tajawal_black info">
                        <div class=" tajawal_black form-group {{ $errors->has('pusher_app_id') ? ' has-error ' : '' }}">
                        ...
                        <div class=" tajawal_black form-group {{ $errors->has('pusher_app_key') ? ' has-error ' : '' }}">
                        ...
                        <div class=" tajawal_black form-group {{ $errors->has('pusher_app_secret') ? ' has-error ' : '' }}">
                ...
                <div class=" tajawal_black buttons">
                    <button class=" tajawal_black button" type="submit">

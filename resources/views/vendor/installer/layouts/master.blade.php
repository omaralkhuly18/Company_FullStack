...
<html>
    ...
    <body>
        <div class=" tajawal_black master">
            <div class=" tajawal_black box">
                <div class=" tajawal_black header">
                    <h1 class=" tajawal_black header__title">@yield('title')</h1>
                </div>
                <ul class=" tajawal_black step">
                    <li class=" tajawal_black step__divider"></li>
                    <li class=" tajawal_black step__item {{ isActive('LaravelInstaller::final') }}">
                        <i class="step__icon fa fa-server" aria-hidden="true"></i>
                    </li>
                    <li class=" tajawal_black step__divider"></li>
                    <li class=" tajawal_black step__item {{ isActive('LaravelInstaller::environment')}} {{ isActive('LaravelInstaller::environmentWizard')}} {{ isActive('LaravelInstaller::environmentClassic')}}">
                    ...
                    <li class=" tajawal_black step__divider"></li>
                    <li class=" tajawal_black step__item {{ isActive('LaravelInstaller::permissions') }}">
                    ...
                    <li class=" tajawal_black step__divider"></li>
                    <li class=" tajawal_black step__item {{ isActive('LaravelInstaller::requirements') }}">
                    ...
                    <li class=" tajawal_black step__divider"></li>
                    <li class=" tajawal_black step__item {{ isActive('LaravelInstaller::welcome') }}">
                        @if(Request::is('install') || Request::is('install/requirements') || Request::is('install/permissions') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                ...
                <div class=" tajawal_black main">
                    @if (session('message'))
                        <p class=" tajawal_black alert text-center">
                            <strong>
                    ...
                    @if(session()->has('errors'))
                        <div class=" tajawal_black alert alert-danger" id="error_alert">
                            <button type="button" class=" tajawal_black close" id="close_alert" data-dismiss="alert" aria-hidden="true">

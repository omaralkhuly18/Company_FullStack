...
@section('container')
    ...
    @foreach($requirements['requirements'] as $type => $requirement)
        <ul class=" tajawal_black list">
            <li class=" tajawal_black list__item list__title {{ $phpSupportInfo['supported'] ? 'success' : 'error' }}">
                ...
                @if($type == 'php')
                    ...
                    <span class=" tajawal_black float-right">
                        <strong>
            ...
            @foreach($requirements['requirements'][$type] as $extention => $enabled)
                <li class=" tajawal_black list__item {{ $enabled ? 'success' : 'error' }}">
                    {{ $extention }}
    ...
    @if ( ! isset($requirements['errors']) && $phpSupportInfo['supported'] )
        <div class=" tajawal_black buttons">
            <a class=" tajawal_black button" href="{{ route('LaravelInstaller::permissions') }}">

...
@section('content')
        ...
        <section class=" tajawal_black services-section-two">
            ...
            <div class=" tajawal_black auto-container">
                <div class=" tajawal_black sec-title text-center light">
                    @if ($app->getLocale() == 'ar')
                        <span class=" tajawal_black sub-title">{{ $HomeFour->service_heading_ar }}</span>
                        <h2>{{ $HomeFour->service_subheading_ar }}
                        </h2>
                    @else
                        <span class=" tajawal_black sub-title">{{ $HomeFour->service_heading }}</span>
                        <h2>{{ $HomeFour->service_subheading }}
                        </h2>
                    @endif
                </div>
    ...
    {{-- Welcome Two --}}
    @if ($HomeFour->welcome_two_status == 1)
    ...
    {{--  Portfolio --}}
    @if ($HomeFour->portfolio_status == 1)
        <section class=" tajawal_black projects-section pt-0">
            <div class=" tajawal_black auto-container">
                <div class=" tajawal_black sec-title text-center">
                    @if ($app->getLocale() == 'ar')
                        <span class=" tajawal_black sub-title">{{ $HomeFour->portfolio_heading_ar }}</span>
                        <h2>{{ $HomeFour->portfolio_subheading_ar }}</h2>
                    @else
                        <span class=" tajawal_black sub-title">{{ $HomeFour->portfolio_heading }}</span>
                        <h2>{{ $HomeFour->portfolio_subheading }}</h2>
                    @endif
                </div>
                <div class=" tajawal_black outer-box">
                    <div class=" tajawal_black row">
                        @foreach ($Portfolios as $Portfolio)
                            <div class=" tajawal_black  project-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp"
                                ...
                                <div class=" tajawal_black inner-box">
                                    <div class=" tajawal_black image-box">
                                        <figure class=" tajawal_black image"><a href=""><img
    ...
    {{-- Choose two --}}
    @if ($HomeFour->choose_two_status == 1)
    ...
    {{-- Testimonial --}}
    @if ($HomeFour->testimonial_status == 1)
        <section class=" tajawal_black testimonial-section-two" style="direction: ltr">
                ...
                <div class=" tajawal_black row">
                    <div class=" tajawal_black title-column col-xl-3 col-lg-4 col-md-12">
                        <div class=" tajawal_black inner-column">
                            <div class=" tajawal_black sec-title">
                                @if ($app->getLocale() == 'ar')
                                    <span class=" tajawal_black sub-title">{{ $HomeFour->testimonial_subheading_ar }}</span>
                                    <h2>{{ $HomeFour->testimonial_heading_ar }}</h2>
                                    <div class=" tajawal_black text">
                                        {{ $HomeFour->testimonial_text_ar }}
                                    </div>
                                @else
                                    <span class=" tajawal_black sub-title">{{ $HomeFour->testimonial_subheading }}</span>
                                    <h2>{{ $HomeFour->testimonial_heading }}</h2>
                                    <div class=" tajawal_black text">
                                        {{ $HomeFour->testimonial_text }}
                                    </div>
                                @endif
                            </div>
                        </div>
                    </div>
                    <div class=" tajawal_black testimonial-column col-xl-9 col-lg-8 col-md-12">
                        <div class=" tajawal_black inner-column">
    ...
    {{-- Team Member --}}
    @if ($HomeFour->team_member_status == 1)
        <section class=" tajawal_black team-section bg-f7 pb-30">
            <div class=" tajawal_black auto-container">
                <div class=" tajawal_black sec-title text-center">
                    @if ($app->getLocale() == 'ar')
                        <span class=" tajawal_black sub-title">{{ $HomeFour->team_member_subheading_ar }}</span>
                        <h2>{{ $HomeFour->team_member_heading_ar }}</h2>
                    @else
                        <span class=" tajawal_black sub-title">{{ $HomeFour->team_member_subheading }}</span>
                        <h2>{{ $HomeFour->team_member_heading }}</h2>
                    @endif
                </div>
    ...
    {{--  Contact --}}
    @if ($HomeFour->contact_status == 1)
        <section class=" tajawal_black contact-section-two" style="direction: ltr">
            <div class=" tajawal_black bg bg-pattern-11"></div>
            <div class=" tajawal_black image-box">
                <div class=" tajawal_black image"><img src="{{ asset('assets/uploads/home_pages/' . $HomeFour->photo_home_four) }}"
                        alt=""></div>
                    ...
                    <div class=" tajawal_black form-column col-lg-7 col-md-12">
                        <div class=" tajawal_black inner-column">
                            <div class=" tajawal_black sec-title light">
                                @if ($app->getLocale() == 'ar')
                                    <span class=" tajawal_black sub-title">{{ $HomeFour->contact_heading_ar }}</span>
                                    <h2>{{ $HomeFour->contact_subheading_ar }}</h2>
                                @else
                                    <span class=" tajawal_black sub-title">{{ $HomeFour->contact_heading }}</span>
                                    <h2>{{ $HomeFour->contact_subheading }}</h2>
                                @endif
                            </div>
    ...
    {{-- Blog --}}
    @if ($HomeFour->blog_status == 1)
        <section class=" tajawal_black news-section">
            <div class=" tajawal_black auto-container">
                <div class=" tajawal_black sec-title text-center">
                    @if ($app->getLocale() == 'ar')
                        <span class=" tajawal_black sub-title">{{ $HomeFour->blog_subheading_ar }}</span>
                        <h2>{{ $HomeFour->blog_heading_ar }}</h2>
                    @else
                        <span class=" tajawal_black sub-title">{{ $HomeFour->blog_subheading }}</span>
                        <h2>{{ $HomeFour->blog_heading }}</h2>
                    @endif
                </div>
                <div class=" tajawal_black row">
